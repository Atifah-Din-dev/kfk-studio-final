// client/src/pages/customer/ServiceDetailsPage.jsx
// ServiceDetailsPage for displaying detailed information about a specific service, including booking options
        ...
        <div className="service-details-container">
            ...
            <div className="service-details-content">
                <div className="service-details-image-container">
                    {service.image ? (
                        (() => {
                            ...
                            return <img src={imageUrl} alt={service.name} className="service-details-image" />;
                        })()
                    ) : (
                ...
                <div className="service-details-info">
                    ...
                    {/* Zoom Button for Frame Services */}
                    {(service.name === 'Horizontal Frame' || service.name === 'Vertical Frame') && (
                        <div className="service-zoom-section">
                            <button
