...
const CheckoutPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // In a real app, you would call your API to process the payment and create the booking
    ...
    // Render order confirmation if order is placed
    if (orderPlaced) {
        return (
            <div className="checkout-container">
                <div className="order-confirmation">
                    ...
                    <div className="order-info">
                        ...
                        <p><strong>Total Amount:</strong> RM{getCartTotal().toFixed(2)}</p>
                    </div>
